...
export default class CityRemaxWelcome extends Component {
    constructor(props) {
        super(props);
    }
    ...
    render() {
        ...
        return (
            <article >
                ...
                {saleRent == 'rent' &&
                <h3 style={{color: "#D32F2F"}}> {
                    "Let us guide you, call us for a free consultation about " + cityName + " properties for rent: (847) 674-9797"
                }
                </h3>
                }
